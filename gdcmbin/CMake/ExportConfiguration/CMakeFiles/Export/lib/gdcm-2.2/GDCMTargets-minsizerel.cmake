...
SET_TARGET_PROPERTIES(gdcmCommon PROPERTIES
  ...
  IMPORTED_LINK_INTERFACE_LIBRARIES_MINSIZEREL "/System/Library/Frameworks/CoreFoundation.framework"
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/lib/libgdcmCommon.a"
  )
...
SET_TARGET_PROPERTIES(gdcmDICT PROPERTIES
  ...
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/lib/libgdcmDICT.a"
  )
...
SET_TARGET_PROPERTIES(gdcmDSED PROPERTIES
  ...
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/lib/libgdcmDSED.a"
  )
...
SET_TARGET_PROPERTIES(gdcmIOD PROPERTIES
  ...
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/lib/libgdcmIOD.a"
  )
...
SET_TARGET_PROPERTIES(gdcmMSFF PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_MINSIZEREL "CXX"
  IMPORTED_LINK_INTERFACE_LIBRARIES_MINSIZEREL "gdcmIOD;gdcmDSED;gdcmDICT;gdcmjpeg8;gdcmjpeg12;gdcmjpeg16;gdcmopenjpeg;gdcmcharls;gdcmuuid"
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/lib/libgdcmMSFF.a"
  )
...
SET_TARGET_PROPERTIES(gdcmMEXD PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_MINSIZEREL "CXX"
  IMPORTED_LINK_INTERFACE_LIBRARIES_MINSIZEREL "gdcmMSFF;gdcmDICT;gdcmDSED;gdcmIOD;socketxx"
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/lib/libgdcmMEXD.a"
  )
...
SET_TARGET_PROPERTIES(gdcmjpeg8 PROPERTIES
  ...
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/lib/libgdcmjpeg8.a"
  )
...
SET_TARGET_PROPERTIES(gdcmjpeg12 PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_MINSIZEREL "C"
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/lib/libgdcmjpeg12.a"
  )
...
SET_TARGET_PROPERTIES(gdcmjpeg16 PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_MINSIZEREL "C"
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/lib/libgdcmjpeg16.a"
  )
...
SET_TARGET_PROPERTIES(gdcmexpat PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_MINSIZEREL "C"
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/lib/libgdcmexpat.a"
  )
...
SET_TARGET_PROPERTIES(gdcmopenjpeg PROPERTIES
  ...
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/lib/libgdcmopenjpeg.a"
  )
...
SET_TARGET_PROPERTIES(gdcmcharls PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_MINSIZEREL "CXX"
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/lib/libgdcmcharls.a"
  )
...
SET_TARGET_PROPERTIES(gdcmzlib PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_MINSIZEREL "C"
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/lib/libgdcmzlib.a"
  )

LIST(APPEND _IMPORT_CHECK_TARGETS gdcmzlib )
LIST(APPEND _IMPORT_CHECK_FILES_FOR_gdcmzlib "${_IMPORT_PREFIX}/lib/libgdcmzlib.a" )

# Import target "gdcmuuid" for configuration "MinSizeRel"
SET_PROPERTY(TARGET gdcmuuid APPEND PROPERTY IMPORTED_CONFIGURATIONS MINSIZEREL)
SET_TARGET_PROPERTIES(gdcmuuid PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_MINSIZEREL "C"
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/lib/libgdcmuuid.a"
  )
...
SET_TARGET_PROPERTIES(socketxx PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_MINSIZEREL "CXX"
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/lib/libsocketxx.a"
  )
